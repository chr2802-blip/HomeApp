...
const eslintConfig = [
  ...
  },
  {
    ...
    files: [
      ...
      "src/components/meal-week.tsx",
      "src/components/meal-picker.tsx",
      "src/components/add-to-meal-plan-menu-item.tsx",
      "src/app/(app)/dashboard/page.tsx",
      "src/components/week-progress.tsx",
      "src/components/notification-setup.tsx",
      "src/components/suggested-recipe.tsx",
      "src/app/(app)/settings/page.tsx",
      "src/components/reminder-status.tsx",
      "src/components/storage-usage.tsx",
      "src/components/ai-spend.tsx",
      "src/components/invite-form.tsx",
      "src/app/(app)/admin/system/page.tsx",
      "src/app/(app)/admin/page.tsx",
      "src/app/(app)/admin/homes/page.tsx",
      "src/app/(app)/homes/page.tsx",
      "src/app/login/page.tsx",
      "src/app/login/login-form.tsx",
      "src/app/accept-invite/page.tsx",
      "src/app/accept-invite/accept-invite-form.tsx",
